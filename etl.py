...
def load_bronze():
    ...
    try:
        ...
        log_run(run_id, "load_bronze", "all_bronze_tables", "success", message="Loaded bronze from CSVs")
...
def build_silver():
    ...
    try:
        ...
        # Counts + rejected rows for this run
        with ENGINE.begin() as conn:
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python etl.py [load_bronze|build_silver]")
        sys.exit(1)
